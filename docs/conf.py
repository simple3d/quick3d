...
breathe_projects = { "quick3d": "./doxyoutput/xml" }
...
exhale_args = {
    ...
    "afterTitleDescription": textwrap.dedent(u'''
        Welcome to the developer reference to quick3d.
    '''),
    ############################################################################
...
latex_documents = [
  (master_doc, 'quick3d.tex', u'quick3d Documentation',
   u'simpl3d', 'manual'),
]
...
man_pages = [
    (master_doc, 'quick3d', u'quick3d Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'quick3d', u'quick3d Documentation',
   author, 'quick3d', 'One line description of project.',
   'Miscellaneous'),
]
